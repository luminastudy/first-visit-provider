 ...
 * ```
 */
export const FirstVisitProvider: React.FC<FirstVisitProviderProps> = props => {
  const { languages, storageKey, onLanguageSelect, children } = props
  ...
  const selectLanguage = useCallback(
    (languageCode: LanguageCode) => {
      try {
        ...
        localStorage.setItem(finalStorageKey, JSON.stringify(data))
    ...
    [languages, finalStorageKey, onLanguageSelect]
  )
